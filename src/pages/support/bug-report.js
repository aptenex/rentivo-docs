...
import {FORM_SUPPORT_BUG, FORM_SUPPORT_GENERAL} from '../../constants/erxesForms';
export default (props) => {

  return (
      <Layout location={props.location} subNav={true}>
        <Container width={'720px'}>
          <Heading fontWeight={600} textAlign={'center'} as={'h1'} content={'Support - Report a Bug'} />
          ...
          <ErxesEmbed embed={FORM_SUPPORT_BUG}  />
        </Container>
      </Layout>
  );
};
