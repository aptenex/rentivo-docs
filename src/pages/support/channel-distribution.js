...
import {FORM_SUPPORT_CHANNEL, FORM_SUPPORT_GENERAL} from '../../constants/erxesForms';
export default (props) => {

  return (
      <Layout location={location} subNav={true}>
        <Container width={'720px'}>
          <Heading fontWeight={600} textAlign={'center'} as={'h1'} content={'Support - Channel Management'} />
          ...
          <ErxesEmbed embed={FORM_SUPPORT_CHANNEL}  />
        </Container>
      </Layout>
  );
};
