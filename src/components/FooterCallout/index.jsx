          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="card card--glossary">
                ...
                <p className="glossary-link"><Link to="/for-developers/sending-email/api-getting-started/">Getting
                  Started</Link></p>
                <p className="glossary-link"><Link to="/api-reference/">API Documentation</Link></p>
                <p className="glossary-link"><Link to="/for-developers/sending-email/libraries/">Code Libraries</Link>
                </p>
